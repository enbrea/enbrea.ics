...
{
    /// <summary>
    /// Represents an iCalendar DATE-TIME Completed property
    /// </summary>
    public class IcsCompleted : IcsProperty
    {
        /// <summary>
        ...
        /// </summary>
        public IcsCompleted()
            : base(IcsPropertyNames.Completed)
        {
        }
        ...
        public IcsCompleted(DateTime value)
            : base(IcsPropertyNames.Completed)
        {
            Value = value;
        }
